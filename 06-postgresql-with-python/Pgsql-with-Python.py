...
# You can think of it as an iterator or pointer for SQL data retrieval
cur = conn.cursor()
...
# Now, let's use our newly created database
...
# Instead of doing a COPY FROM query 8 times, we should utilize Python to make this more efficient
# This is possible due to tokenized strings
